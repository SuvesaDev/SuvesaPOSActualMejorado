...
Public Class Reporte_acciones_empleados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_acciones_empleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_acciones_empleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_acciones_empleados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_acciones_empleados = New Reporte_acciones_empleados()
        rpt.Site = Me.Site
        Return rpt
    End Function
