...
Public Class rptCxCentreFechas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptCxCentreFechas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCxCentreFechas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCxCentreFechas = New rptCxCentreFechas()
        rpt.Site = Me.Site
        Return rpt
    End Function
