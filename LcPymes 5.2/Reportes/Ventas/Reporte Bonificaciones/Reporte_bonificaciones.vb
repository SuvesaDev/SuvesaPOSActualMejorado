...
Public Class Reporte_bonificaciones
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_bonificaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_bonificaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_bonificaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_bonificaciones = New Reporte_bonificaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
