...
Public Class Ventas_grafico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Ventas_grafico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentas_grafico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ventas_grafico = New Ventas_grafico()
        rpt.Site = Me.Site
        Return rpt
    End Function
