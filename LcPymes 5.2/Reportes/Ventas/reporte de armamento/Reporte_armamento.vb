...
Public Class Reporte_armamento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_armamento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_armamento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_armamento = New Reporte_armamento()
        rpt.Site = Me.Site
        Return rpt
    End Function
