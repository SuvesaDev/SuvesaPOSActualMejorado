...
Public Class frmReporteArmamento
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Friend WithEvents ckcliente As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ckcliente = New System.Windows.Forms.CheckBox
        Me.SuspendLayout()
        '
        'Label4
        '
        ...
        'ButtonMostrar
        '
        Me.ButtonMostrar.Location = New System.Drawing.Point(648, 32)
        ...
        Me.VisorReporte.Size = New System.Drawing.Size(800, 368)
        ...
        'ckcliente
        '
        Me.ckcliente.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.ckcliente.Location = New System.Drawing.Point(224, 32)
        Me.ckcliente.Name = "ckcliente"
        Me.ckcliente.Size = New System.Drawing.Size(256, 24)
        Me.ckcliente.TabIndex = 101
        Me.ckcliente.Text = "Reporte de venta de municiones"
        '
        'frmReporteArmamento
        '
        ...
        Me.Controls.Add(Me.ckcliente)
        Me.Name = "frmReporteArmamento"
        Me.Text = "Reporte Armamento"
...
#End Region
    ...
    Private Sub esKatty()
        ...
        If katty = "1" Then 'si es katty
            ...
            Me.Katty = True
            Me.Text = "Reporte de Ventas de Alimentos"
            Me.ckcliente.Visible = False
    ...
    Private Sub frmReporteArmamento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.esKatty()
    ...
    Private Sub ButtonMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonMostrar.Click
        Dim rpt As New Reporte_armamento
        Dim rptcliente As New Reporte_armamento_x_cliente
        If Me.ckcliente.Checked = True Then
            rptcliente.SetParameterValue(0, Me.FechaInicio.Value)
            rptcliente.SetParameterValue(1, Me.FechaFinal.Value)
            CrystalReportsConexion.LoadReportViewer(VisorReporte, rptcliente, , SqlConnection1.ConnectionString)
        Else
