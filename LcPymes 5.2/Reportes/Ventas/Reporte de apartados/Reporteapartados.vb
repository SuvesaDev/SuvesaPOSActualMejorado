...
Public Class Reporteapartados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporteapartados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteapartados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporteapartados = New Reporteapartados()
        rpt.Site = Me.Site
        Return rpt
    End Function
