...
Public Class VentasUnificadas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.VentasUnificadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasUnificadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasUnificadas = New VentasUnificadas()
        rpt.Site = Me.Site
        Return rpt
    End Function
