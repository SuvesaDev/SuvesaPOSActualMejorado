...
Public Class Reporte_ventas_productos_organicos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_ventas_productos_organicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_ventas_productos_organicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Katty() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_ventas_productos_organicos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_ventas_productos_organicos = New Reporte_ventas_productos_organicos()
        rpt.Site = Me.Site
        Return rpt
    End Function
