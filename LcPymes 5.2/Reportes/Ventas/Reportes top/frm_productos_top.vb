Imports System.Data
Public Class frm_productos_top
    Private Sub frm_productos_top_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ButtonMostrar_Click(sender As Object, e As EventArgs) Handles ButtonMostrar.Click
        Dim rpt As New Ventasxproductos_top_10
        If ComboBox2.SelectedIndex = 0 Then
            ...
            VisorReporte.Show()
        Else
            rpt.RecordSelectionFormula = "{reporte_producto_mas_vendido;1.total} " & Me.cbxCondicion.Text & " " & txtCantidad.Text
            rpt.SetParameterValue(0, Me.FechaInicio.Value)
            rpt.SetParameterValue(1, Me.FechaFinal.Value)
            CrystalReportsConexion.LoadReportViewer(VisorReporte, rpt, , SqlConnection1.ConnectionString)
            VisorReporte.Show()
