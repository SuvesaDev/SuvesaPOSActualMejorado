...
Public Class Bitacora_reimpresiones
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Bitacora_reimpresiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Bitacora_reimpresiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_usuariorpt_Pm_AjusteInventarioCedula() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBitacora_reimpresiones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Bitacora_reimpresiones = New Bitacora_reimpresiones()
        rpt.Site = Me.Site
        Return rpt
    End Function
