...
Public Class rptVentasAlbaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptVentasAlbaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasAlbaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasAlbaran = New rptVentasAlbaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
