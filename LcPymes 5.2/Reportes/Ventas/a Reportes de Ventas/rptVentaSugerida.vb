...
Public Class rptVentaSugerida
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptVentaSugerida.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentaSugerida
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentaSugerida = New rptVentaSugerida()
        rpt.Site = Me.Site
        Return rpt
    End Function
