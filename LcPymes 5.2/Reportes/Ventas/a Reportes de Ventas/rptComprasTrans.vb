...
Public Class rptComprasTrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptComprasTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComprasTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprasTrans = New rptComprasTrans()
        rpt.Site = Me.Site
        Return rpt
    End Function
