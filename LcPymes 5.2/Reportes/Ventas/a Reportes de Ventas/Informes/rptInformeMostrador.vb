...
Public Class rptInformeMostrador
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInformeMostrador.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptInformeMostrador.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInformeMostrador
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInformeMostrador = New rptInformeMostrador()
        rpt.Site = Me.Site
        Return rpt
    End Function
