...
Public Class rptCreditoyRecupeacion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCreditoyRecupeacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptCreditoyRecupeacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCreditoyRecupeacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCreditoyRecupeacion = New rptCreditoyRecupeacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
