...
Public Class rptReporteMensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptReporteMensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteMensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteMensual = New rptReporteMensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
