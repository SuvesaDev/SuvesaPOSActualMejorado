...
Public Class rptBitacoraLaboratorio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBitacoraLaboratorio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptBitacoraLaboratorio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBitacoraLaboratorio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBitacoraLaboratorio = New rptBitacoraLaboratorio()
        rpt.Site = Me.Site
        Return rpt
    End Function
