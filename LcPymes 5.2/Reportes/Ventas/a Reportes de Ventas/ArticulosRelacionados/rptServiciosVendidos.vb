...
Public Class rptServiciosVendidos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptServiciosVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptServiciosVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptServiciosVendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptServiciosVendidos = New rptServiciosVendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
