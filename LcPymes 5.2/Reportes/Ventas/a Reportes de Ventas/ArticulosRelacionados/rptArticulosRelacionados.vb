...
Public Class rptArticulosRelacionados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptArticulosRelacionados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptArticulosRelacionados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptArticulosRelacionados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptArticulosRelacionados = New rptArticulosRelacionados()
        rpt.Site = Me.Site
        Return rpt
    End Function
