...
Public Class rptDetallaApertura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptDetallaApertura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDetallaApertura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetallaApertura = New rptDetallaApertura()
        rpt.Site = Me.Site
        Return rpt
    End Function
