...
Public Class rptFamiliaxFamilia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptFamiliaxFamilia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFamiliaxFamilia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFamiliaxFamilia = New rptFamiliaxFamilia()
        rpt.Site = Me.Site
        Return rpt
    End Function
