...
Public Class rptArticulosComprados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptArticulosComprados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptArticulosComprados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptArticulosComprados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptArticulosComprados = New rptArticulosComprados()
        rpt.Site = Me.Site
        Return rpt
    End Function
