...
Public Class rptVentasHoras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptVentasHoras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasHoras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasHoras = New rptVentasHoras()
        rpt.Site = Me.Site
        Return rpt
    End Function
