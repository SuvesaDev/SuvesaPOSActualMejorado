...
Public Class rptControlAlbaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptControlAlbaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptControlAlbaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptControlAlbaran = New rptControlAlbaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
