...
Public Class rptSaldosPrepago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptSaldosPrepago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldosPrepago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldosPrepago = New rptSaldosPrepago()
        rpt.Site = Me.Site
        Return rpt
    End Function
