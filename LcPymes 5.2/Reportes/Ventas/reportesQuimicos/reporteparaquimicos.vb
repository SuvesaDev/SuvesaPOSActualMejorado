...
Public Class reporteparaquimicos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "reporteparaquimicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.reporteparaquimicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreporteparaquimicos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporteparaquimicos = New reporteparaquimicos()
        rpt.Site = Me.Site
        Return rpt
    End Function
