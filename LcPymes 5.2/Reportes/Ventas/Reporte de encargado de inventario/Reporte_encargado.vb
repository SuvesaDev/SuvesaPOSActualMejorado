...
Public Class Reporte_encargado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_encargado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_encargado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_encargado = New Reporte_encargado()
        rpt.Site = Me.Site
        Return rpt
    End Function
