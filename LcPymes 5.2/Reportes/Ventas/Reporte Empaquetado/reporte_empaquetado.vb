...
Public Class reporte_empaquetado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "reporte_empaquetado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.reporte_empaquetado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fechaIN() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedreporte_empaquetado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_empaquetado = New reporte_empaquetado()
        rpt.Site = Me.Site
        Return rpt
    End Function
