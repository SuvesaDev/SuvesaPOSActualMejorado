...
Public Class Recibos_de_Abono
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Recibos de Abono.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecibos_de_Abono
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Recibos_de_Abono = New Recibos_de_Abono()
        rpt.Site = Me.Site
        Return rpt
    End Function
