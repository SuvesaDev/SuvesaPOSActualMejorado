...
Public Class ReporteVentasReales
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteVentasReales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ReporteVentasReales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MonedaNombre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteVentasReales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteVentasReales = New ReporteVentasReales()
        rpt.Site = Me.Site
        Return rpt
    End Function
