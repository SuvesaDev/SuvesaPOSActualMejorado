...
Public Class Reporte_Ventas_Anuladas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Ventas_Anuladas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_Ventas_Anuladas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Ventas_Anuladas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Ventas_Anuladas = New Reporte_Ventas_Anuladas()
        rpt.Site = Me.Site
        Return rpt
    End Function
