...
Public Class VentaxCategoria2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.VentaxCategoria2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaxCategoria2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaxCategoria2 = New VentaxCategoria2()
        rpt.Site = Me.Site
        Return rpt
    End Function
