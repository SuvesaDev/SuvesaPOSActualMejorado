...
Public Class Ventas_Detalladas_General_Tipo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Ventas_Detalladas_General_Tipo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Ventas_Detalladas_General_Tipo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Devolucionesrpt_TipoCambio() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedVentas_Detalladas_General_Tipo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ventas_Detalladas_General_Tipo = New Ventas_Detalladas_General_Tipo()
        rpt.Site = Me.Site
        Return rpt
    End Function
