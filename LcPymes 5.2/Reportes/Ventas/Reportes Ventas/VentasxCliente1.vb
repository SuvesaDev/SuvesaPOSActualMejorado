...
Public Class VentasxCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.VentasxCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Devolucionesrpt_Cliente() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedVentasxCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasxCliente = New VentasxCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
