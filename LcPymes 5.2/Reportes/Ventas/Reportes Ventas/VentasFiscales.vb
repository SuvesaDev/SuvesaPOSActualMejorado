...
Public Class VentasFiscales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.VentasFiscales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasFiscales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasFiscales = New VentasFiscales()
        rpt.Site = Me.Site
        Return rpt
    End Function
