...
Public Class ComprasxFechas2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ComprasxFechas2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_resumen() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedComprasxFechas2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasxFechas2 = New ComprasxFechas2()
        rpt.Site = Me.Site
        Return rpt
    End Function
