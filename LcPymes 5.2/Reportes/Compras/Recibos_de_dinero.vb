...
Public Class Recibos_de_dinero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Recibos_de_dinero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecibos_de_dinero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Recibos_de_dinero = New Recibos_de_dinero()
        rpt.Site = Me.Site
        Return rpt
    End Function
