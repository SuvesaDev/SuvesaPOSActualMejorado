...
Public Class NotaCréditoCXP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.NotaCréditoCXP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCréditoCXP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCréditoCXP = New NotaCréditoCXP()
        rpt.Site = Me.Site
        Return rpt
    End Function
