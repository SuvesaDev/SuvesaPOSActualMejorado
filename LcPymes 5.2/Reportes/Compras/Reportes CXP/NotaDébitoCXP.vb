...
Public Class NotaDébitoCXP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.NotaDébitoCXP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaDébitoCXP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaDébitoCXP = New NotaDébitoCXP()
        rpt.Site = Me.Site
        Return rpt
    End Function
