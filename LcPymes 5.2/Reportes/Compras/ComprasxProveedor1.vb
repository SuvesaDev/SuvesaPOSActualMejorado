...
Public Class ComprasxProveedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ComprasxProveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasxProveedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasxProveedor = New ComprasxProveedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
