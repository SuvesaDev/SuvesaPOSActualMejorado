...
Public Class ComprasxFechas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ComprasxFechas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasxFechas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasxFechas = New ComprasxFechas()
        rpt.Site = Me.Site
        Return rpt
    End Function
