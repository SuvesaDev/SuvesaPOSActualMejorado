...
Public Class ComprasxProveedorX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ComprasxProveedorX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasxProveedorX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasxProveedorX = New ComprasxProveedorX()
        rpt.Site = Me.Site
        Return rpt
    End Function
