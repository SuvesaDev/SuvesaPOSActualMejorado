...
Public Class rptMovimientoCompra
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMovimientoCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptMovimientoCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_Compra() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptMovimientoCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovimientoCompra = New rptMovimientoCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
