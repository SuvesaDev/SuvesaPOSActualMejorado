...
Public Class rptInventarioxProveedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInventarioxProveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptInventarioxProveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ConExistencias() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptInventarioxProveedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventarioxProveedor = New rptInventarioxProveedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
