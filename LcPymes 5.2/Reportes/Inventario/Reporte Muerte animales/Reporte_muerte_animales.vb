...
Public Class Reporte_muerte_animales
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_muerte_animales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_muerte_animales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_muerte_animales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_muerte_animales = New Reporte_muerte_animales()
        rpt.Site = Me.Site
        Return rpt
    End Function
