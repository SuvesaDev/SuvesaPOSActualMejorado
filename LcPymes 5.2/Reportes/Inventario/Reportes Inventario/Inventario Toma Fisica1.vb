...
Public Class Inventario_Toma_Fisica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Inventario Toma Fisica.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Inventario Toma Fisica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventario_Toma_Fisica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Inventario_Toma_Fisica = New Inventario_Toma_Fisica()
        rpt.Site = Me.Site
        Return rpt
    End Function
