...
Public Class InventarioxServicios
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InventarioxServicios.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.InventarioxServicios.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CodigoP() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInventarioxServicios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioxServicios = New InventarioxServicios()
        rpt.Site = Me.Site
        Return rpt
    End Function
