...
Public Class ArticulosxPedir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ArticulosxPedir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedArticulosxPedir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ArticulosxPedir = New ArticulosxPedir()
        rpt.Site = Me.Site
        Return rpt
    End Function
