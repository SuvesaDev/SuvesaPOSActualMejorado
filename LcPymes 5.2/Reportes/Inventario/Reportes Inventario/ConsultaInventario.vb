...
Public Class ConsultaInventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ConsultaInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CCodigo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedConsultaInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsultaInventario = New ConsultaInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
