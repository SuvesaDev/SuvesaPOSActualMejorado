...
Public Class InventarioxCategoria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InventarioxCategoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.InventarioxCategoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Codd() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInventarioxCategoria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventarioxCategoria = New InventarioxCategoria()
        rpt.Site = Me.Site
        Return rpt
    End Function
