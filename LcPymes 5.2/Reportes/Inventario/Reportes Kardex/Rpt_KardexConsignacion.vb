...
Public Class Rpt_KardexConsignacion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_KardexConsignacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Rpt_KardexConsignacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TituloKardex() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_KardexConsignacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KardexConsignacion = New Rpt_KardexConsignacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
