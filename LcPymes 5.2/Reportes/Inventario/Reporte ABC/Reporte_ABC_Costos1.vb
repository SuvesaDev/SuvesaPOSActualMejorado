...
Public Class Reporte_ABC_Costos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_ABC_Costos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_ABC_Costos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_ABC_Costos = New Reporte_ABC_Costos()
        rpt.Site = Me.Site
        Return rpt
    End Function
