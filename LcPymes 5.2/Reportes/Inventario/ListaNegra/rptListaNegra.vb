...
Public Class rptListaNegra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptListaNegra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaNegra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaNegra = New rptListaNegra()
        rpt.Site = Me.Site
        Return rpt
    End Function
