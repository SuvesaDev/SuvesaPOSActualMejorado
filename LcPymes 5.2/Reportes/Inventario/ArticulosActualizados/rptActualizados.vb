...
Public Class rptActualizados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptActualizados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_opt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptActualizados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActualizados = New rptActualizados()
        rpt.Site = Me.Site
        Return rpt
    End Function
