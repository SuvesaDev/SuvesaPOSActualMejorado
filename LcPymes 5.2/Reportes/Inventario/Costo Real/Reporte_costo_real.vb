...
Public Class Reporte_costo_real
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_costo_real.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_costo_real
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_costo_real = New Reporte_costo_real()
        rpt.Site = Me.Site
        Return rpt
    End Function
