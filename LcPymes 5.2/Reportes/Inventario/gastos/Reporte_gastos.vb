...
Public Class Reporte_gastos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_gastos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_gastos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_gastos = New Reporte_gastos()
        rpt.Site = Me.Site
        Return rpt
    End Function
