...
Public Class rptVentasAnual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptVentasAnual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasAnual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasAnual = New rptVentasAnual()
        rpt.Site = Me.Site
        Return rpt
    End Function
