...
#Region "Variables"
    ...
    Friend WithEvents Existencia2 As System.Windows.Forms.DataGridViewTextBoxColumn
    ...
    Friend WithEvents ConsignacionDataGridViewCheckBoxColumn As System.Windows.Forms.DataGridViewCheckBoxColumn
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Existencia2 = New System.Windows.Forms.DataGridViewTextBoxColumn()
        ...
        Me.ConsignacionDataGridViewCheckBoxColumn = New System.Windows.Forms.DataGridViewCheckBoxColumn()
    ...
    "ource=""DESKTOP-8M1A70L"";persist security info=False;initial catalog=seepos"
        ...
        'Existencia2
        '
        Me.Existencia2.DataPropertyName = "Existencia2"
        Me.Existencia2.HeaderText = "Existencia2"
        Me.Existencia2.Name = "Existencia2"
        Me.Existencia2.ReadOnly = True
        Me.Existencia2.Width = 50
        '
        ...
        '
        'ConsignacionDataGridViewCheckBoxColumn
        '
        Me.ConsignacionDataGridViewCheckBoxColumn.DataPropertyName = "Consignacion"
        Me.ConsignacionDataGridViewCheckBoxColumn.HeaderText = "Consignacion"
        Me.ConsignacionDataGridViewCheckBoxColumn.Name = "ConsignacionDataGridViewCheckBoxColumn"
        Me.ConsignacionDataGridViewCheckBoxColumn.ReadOnly = True
        Me.ConsignacionDataGridViewCheckBoxColumn.Resizable = System.Windows.Forms.DataGridViewTriState.[True]
        Me.ConsignacionDataGridViewCheckBoxColumn.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic
        Me.ConsignacionDataGridViewCheckBoxColumn.Visible = False
        '
...
#End Region
    ...
    Private Sub TextBoxBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBoxBuscar.TextChanged
        ...
        End If
    End Sub
    Public SoloSinBarras As Boolean = False
    ...
    Private Sub pone_color()
        ...
        t = (From x As DataGridViewRow In Me.viewDatos.Rows Where CDec(x.Cells("ExistenciaDataGridViewTextBoxColumn").Value) < 0 And x.Cells("ConsignacionDataGridViewCheckBoxColumn").Value = False Select x).ToList
        ...
        t = (From x As DataGridViewRow In Me.viewDatos.Rows Where x.Cells("ConsignacionDataGridViewCheckBoxColumn").Value = True Select x).ToList
