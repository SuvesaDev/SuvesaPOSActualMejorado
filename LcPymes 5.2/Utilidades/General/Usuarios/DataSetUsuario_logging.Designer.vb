...
Partial Public Class DataSetUsuario_logging
    ...
    Partial Public Class UsuariosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUsuariosRow(ByVal Cedula As String, ByVal Nombre As String, ByVal Clave_Entrada As String, ByVal Clave_Interna As String, ByVal Foto() As Byte, ByVal CambiarPrecio As Boolean, ByVal Porc_Precio As Double, ByVal Aplicar_Desc As Boolean, ByVal Porc_Desc As Double, ByVal Exist_Negativa As Boolean) As UsuariosRow
            Dim rowUsuariosRow As UsuariosRow = CType(Me.NewRow,UsuariosRow)
            Dim columnValuesArray() As Object = New Object() {Cedula, Nombre, Clave_Entrada, Clave_Interna, Foto, CambiarPrecio, Porc_Precio, Aplicar_Desc, Porc_Desc, Exist_Negativa}
    ...
    Partial Public Class configuracionesRow
        ...
        Public Property regalias() As Boolean
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'regalias' in table 'configuraciones' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsregaliasNull() As Boolean
            Return Me.IsNull(Me.tableconfiguraciones.regaliasColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetregaliasNull()
            Me(Me.tableconfiguraciones.regaliasColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
