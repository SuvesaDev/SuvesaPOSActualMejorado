...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents CheckBoxInhabilitados As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        Me.CheckBoxInhabilitados.BackColor = System.Drawing.Color.FromArgb(CType(128, Byte), CType(128, Byte), CType(255, Byte))
        ...
        Me.CheckBoxInhabilitados.ForeColor = System.Drawing.Color.White
        Me.CheckBoxInhabilitados.Location = New System.Drawing.Point(336, 0)
        Me.CheckBoxInhabilitados.Name = "CheckBoxInhabilitados"
        Me.CheckBoxInhabilitados.Size = New System.Drawing.Size(128, 16)
        Me.CheckBoxInhabilitados.TabIndex = 5
        Me.CheckBoxInhabilitados.Text = "Buscar Inhabilitados"
        '
        'BuscarCliente
        '
...
#Region "Variables"
    ...
    Dim sWhere As String = "where anulado = 0"
#End Region
    ...
    Private Sub Buscar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cargarInformacion(" where anulado = 0")
        Me.txtBusqueda.Focus()
    End Sub

    Private Sub cargarInformacion(ByVal sWhere As String)
        Try
            ''& IIf(Me.CheckBoxInHabilitados.Checked = True, "", " and Inhabilitado = 0")
            If Me.txtBusqueda.Text = "" And Me.CheckBoxInhabilitados.Checked = False Then
                sWhere = " " & "  where anulado = 0"
            End If

            If Me.txtBusqueda.Text = "" And Me.CheckBoxInhabilitados.Checked = True Then
                sWhere = " " & "  where anulado = 1"
            End If
    ...
    Private Sub txtBusqueda_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBusqueda.TextChanged
        If Len(txtBusqueda.Text) > 2 Then
            If sqlstring.IndexOf("where") > 0 Then
                ...
                If Me.CheckBoxInhabilitados.Checked = True Then

                    cargarInformacion("and " & campo & " like '%" & txtBusqueda.Text & "%' and anulado = 1 ")
                    txtBusqueda.Focus()

                Else

                    cargarInformacion("and " & campo & " like '%" & txtBusqueda.Text & "%' and anulado = 0 ")
                    txtBusqueda.Focus()
            ...
            Else
                ...
                If Me.CheckBoxInhabilitados.Checked = True Then
                    ...
                    cargarInformacion(" WHERE " & campo & " like '%" & txtBusqueda.Text & "%' and anulado = 1")
                    txtBusqueda.Focus()

                Else
                    cargarInformacion(" WHERE " & campo & " like '%" & txtBusqueda.Text & "%' and anulado = 0")
                    txtBusqueda.Focus()
