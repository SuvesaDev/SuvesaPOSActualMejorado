...
Public Class ReporteCierreControl
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteCierreControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ReporteCierreControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Abonos() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteCierreControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCierreControl = New ReporteCierreControl()
        rpt.Site = Me.Site
        Return rpt
    End Function
