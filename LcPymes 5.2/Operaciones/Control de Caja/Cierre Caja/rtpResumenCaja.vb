...
Public Class rtpResumenCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rtpResumenCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrtpResumenCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rtpResumenCaja = New rtpResumenCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
