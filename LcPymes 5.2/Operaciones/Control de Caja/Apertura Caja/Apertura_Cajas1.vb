...
Public Class Apertura_Cajas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Apertura_Cajas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Napertura() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedApertura_Cajas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Apertura_Cajas = New Apertura_Cajas()
        rpt.Site = Me.Site
        Return rpt
    End Function
