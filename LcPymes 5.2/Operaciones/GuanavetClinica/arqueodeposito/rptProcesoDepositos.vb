...
Public Class rptProcesoDepositos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptProcesoDepositos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptProcesoDepositos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProcesoDepositos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProcesoDepositos = New rptProcesoDepositos()
        rpt.Site = Me.Site
        Return rpt
    End Function
