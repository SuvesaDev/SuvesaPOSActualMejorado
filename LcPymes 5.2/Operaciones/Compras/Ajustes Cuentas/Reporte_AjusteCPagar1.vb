...
Public Class Reporte_AjusteCPagar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_AjusteCPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_AjusteCPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_Ajuste() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_AjusteCPagar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_AjusteCPagar = New Reporte_AjusteCPagar()
        rpt.Site = Me.Site
        Return rpt
    End Function
