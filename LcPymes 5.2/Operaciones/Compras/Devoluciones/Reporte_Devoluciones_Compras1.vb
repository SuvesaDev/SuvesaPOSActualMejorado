...
Public Class Reporte_Devoluciones_Compras
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Devoluciones_Compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_Devoluciones_Compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Num_Devo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_Devoluciones_Compras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Devoluciones_Compras = New Reporte_Devoluciones_Compras()
        rpt.Site = Me.Site
        Return rpt
    End Function
