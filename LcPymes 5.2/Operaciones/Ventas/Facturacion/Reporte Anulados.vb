...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'dgv_anulados
        '
        Me.dgv_anulados.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.dgv_anulados.DataMember = ""
        Me.dgv_anulados.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.dgv_anulados.Location = New System.Drawing.Point(8, 69)
        Me.dgv_anulados.Name = "dgv_anulados"
        Me.dgv_anulados.Size = New System.Drawing.Size(736, 283)
...
#End Region
    ...
    Public Sub rellenar_grid(ByVal ini As Date, ByVal fin As Date)
        ...
        Dim sentencia As String = "Select NUM_FACTURA AS FACTURA,tipo AS [TIPO FACTURA] ,fecha AS [FECHA ANULACION] ,descripcion AS DESCRIPCION,nombre as NOMBRE, Administrador as ADMINISTRADOR from vista_anulados where fecha between '" & ini & "' and '" & fin & "' "
    ...
    Private Sub Reporte_Anulados_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
