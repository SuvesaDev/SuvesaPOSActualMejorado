...
Public Class rptTiqueteRifa2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptTiqueteRifa2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTiqueteRifa2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTiqueteRifa2 = New rptTiqueteRifa2()
        rpt.Site = Me.Site
        Return rpt
    End Function
