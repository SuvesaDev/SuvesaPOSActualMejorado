...
Public Class Factura_Generica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Factura_Generica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFactura_Generica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Factura_Generica = New Factura_Generica()
        rpt.Site = Me.Site
        Return rpt
    End Function
