...
Public Class ReciboDinero_doble
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ReciboDinero_doble.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciboDinero_doble
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboDinero_doble = New ReciboDinero_doble()
        rpt.Site = Me.Site
        Return rpt
    End Function
