...
Public Class ReciboDineroPV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.ReciboDineroPV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReciboDineroPV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReciboDineroPV = New ReciboDineroPV()
        rpt.Site = Me.Site
        Return rpt
    End Function
