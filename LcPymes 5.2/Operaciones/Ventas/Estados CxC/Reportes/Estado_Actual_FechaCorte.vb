...
Public Class Estado_Actual_FechaCorte
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Estado_Actual_FechaCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Estado_Actual_FechaCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FiltrarIncobrable() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEstado_Actual_FechaCorte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Estado_Actual_FechaCorte = New Estado_Actual_FechaCorte()
        rpt.Site = Me.Site
        Return rpt
    End Function
