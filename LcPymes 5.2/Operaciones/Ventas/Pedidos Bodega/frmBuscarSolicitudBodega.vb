...
Imports System.Data
Public Class frmBuscarSolicitudBodega
    ...
    Private Sub Buscar(_texto As String)
        ...
        cFunciones.Llenar_Tabla_Generico("select idsolicitud, descripcion, fecha, anulado from Solicitud where descripcion like '%" & _texto & "%'", dt, CadenaConexionSeePOS)
