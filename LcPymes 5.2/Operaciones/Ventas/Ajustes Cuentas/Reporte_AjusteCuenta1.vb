...
Public Class Reporte_AjusteCuenta
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_AjusteCuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_AjusteCuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_AjusteCuenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_AjusteCuenta = New Reporte_AjusteCuenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
