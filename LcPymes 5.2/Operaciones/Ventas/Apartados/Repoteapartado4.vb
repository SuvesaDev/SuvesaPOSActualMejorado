...
Public Class Repoteapartado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Repoteapartado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepoteapartado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Repoteapartado = New Repoteapartado()
        rpt.Site = Me.Site
        Return rpt
    End Function
