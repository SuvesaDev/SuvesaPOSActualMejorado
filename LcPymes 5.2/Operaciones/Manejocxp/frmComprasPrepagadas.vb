...
Public Class frmComprasPrepagadas
    ...
    Private Sub CargarComprasPagadassinAplicar()
        ...
        cFunciones.Llenar_Tabla_Generico("Select p.Nombre AS Proveedor, c.Factura, c.Fecha, c.TotalFactura from Compras c   INNER JOIN Proveedores p ON c.CodigoProv = p.CodigoProv   where c.FacturaCancelado = 0 and c.Prepagada = 1", dt, CadenaConexionSeePOS)
