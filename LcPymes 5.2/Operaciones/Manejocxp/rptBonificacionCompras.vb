...
Public Class rptBonificacionCompras
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBonificacionCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptBonificacionCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBonificacionCompras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBonificacionCompras = New rptBonificacionCompras()
        rpt.Site = Me.Site
        Return rpt
    End Function
