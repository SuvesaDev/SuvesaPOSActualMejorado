...
Public Class rptDespositos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptDespositos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDespositos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDespositos = New rptDespositos()
        rpt.Site = Me.Site
        Return rpt
    End Function
