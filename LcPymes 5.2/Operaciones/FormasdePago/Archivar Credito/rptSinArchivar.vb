...
Public Class rptSinArchivar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptSinArchivar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSinArchivar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSinArchivar = New rptSinArchivar()
        rpt.Site = Me.Site
        Return rpt
    End Function
