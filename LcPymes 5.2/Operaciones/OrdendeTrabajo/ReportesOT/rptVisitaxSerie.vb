...
Public Class rptVisitaxSerie
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptVisitaxSerie.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVisitaxSerie
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVisitaxSerie = New rptVisitaxSerie()
        rpt.Site = Me.Site
        Return rpt
    End Function
