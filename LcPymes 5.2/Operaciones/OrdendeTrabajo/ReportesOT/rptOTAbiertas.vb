...
Public Class rptOTAbiertas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptOTAbiertas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOTAbiertas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOTAbiertas = New rptOTAbiertas()
        rpt.Site = Me.Site
        Return rpt
    End Function
