...
Public Class rptBoletaOT_Cierre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptBoletaOT_Cierre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBoletaOT_Cierre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBoletaOT_Cierre = New rptBoletaOT_Cierre()
        rpt.Site = Me.Site
        Return rpt
    End Function
