...
Public Class rptBoletaOT_PVE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptBoletaOT_PVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBoletaOT_PVE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBoletaOT_PVE = New rptBoletaOT_PVE()
        rpt.Site = Me.Site
        Return rpt
    End Function
