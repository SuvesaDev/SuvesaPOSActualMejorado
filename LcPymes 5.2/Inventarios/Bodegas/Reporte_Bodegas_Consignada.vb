...
Public Class Reporte_Bodegas_Consignada
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Bodegas_Consignada.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_Bodegas_Consignada.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_BodegaSeleccionada() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_Bodegas_Consignada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Bodegas_Consignada = New Reporte_Bodegas_Consignada()
        rpt.Site = Me.Site
        Return rpt
    End Function
