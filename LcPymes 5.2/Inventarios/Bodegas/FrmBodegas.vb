...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TextBoxBuscar.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSetBodegas, "Bodegas.Nombre_Bodega"))
        Me.TextBoxBuscar.ForeColor = System.Drawing.Color.FromArgb(CType(0, Byte), CType(0, Byte), CType(192, Byte))
        ...
        Me.TextBox1.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSetBodegas, "Bodegas.Observaciones"))
        ...
        Me.TextBox1.Size = New System.Drawing.Size(574, 64)
        ...
        'SqlInsertCommand1
        '
        Me.SqlInsertCommand1.CommandText = "INSERT INTO Bodegas(ID_Bodega, Nombre_Bodega, Observaciones) VALUES (@ID_Bodega, " & _
        "@Nombre_Bodega, @Observaciones); SELECT ID_Bodega, Nombre_Bodega, Observaciones " & _
        "FROM Bodegas WHERE (ID_Bodega = @ID_Bodega)"
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Nombre_Bodega", System.Data.SqlDbType.VarChar, 100, "Nombre_Bodega"))
        ...
        'SqlUpdateCommand1
        '
        Me.SqlUpdateCommand1.CommandText = "UPDATE Bodegas SET ID_Bodega = @ID_Bodega, Nombre_Bodega = @Nombre_Bodega, Observ" & _
        "aciones = @Observaciones WHERE (ID_Bodega = @Original_ID_Bodega); SELECT ID_Bode" & _
        "ga, Nombre_Bodega, Observaciones FROM Bodegas WHERE (ID_Bodega = @ID_Bodega)"
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Nombre_Bodega", System.Data.SqlDbType.VarChar, 100, "Nombre_Bodega"))
        ...
        'SqlSelectCommand2
        '
        Me.SqlSelectCommand2.CommandText = "SELECT Inventario.Codigo, Inventario.Descripcion + ' ( ' + CAST(Inventario.Presen" & _
        "taCant AS varchar) + ' ' + Presentaciones.Presentaciones + ') ' AS Descripcion, " & _
        "Inventario.Id_Bodega, Inventario.ExistenciaBodega, Inventario.Cod_Articulo FROM " & _
        "Inventario LEFT OUTER JOIN Presentaciones ON Inventario.CodPresentacion = Presen" & _
        "taciones.CodPres WHERE (Inhabilitado = 0) AND (Inventario.Consignacion = 1) AND " & _
        "(Inventario.Id_Bodega > 0)"
        Me.SqlSelectCommand2.Connection = Me.SqlConnection
        '
        'Label_Id
        '
        Me.Label_Id.BackColor = System.Drawing.Color.White
        Me.Label_Id.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSetBodegas, "Bodegas.ID_Bodega"))
