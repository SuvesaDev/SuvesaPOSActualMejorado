...
Public Class frmTrasladosDepartamentos
    Private WithEvents cls As New OBSoluciones.Inventario.Traslado_PuntoVenta
    Private idtraslado As Long = 0
    ...
    Sub guardar()
        cls = New OBSoluciones.Inventario.Traslado_PuntoVenta
        cls.Id = Me.idtraslado
        cls.Fecha = Me.dt_fecha.Value
        cls.Id_PuntoVentaOrigen = Me.cboPuntoVentaOrigen.SelectedValue
        cls.Id_PuntoVentaDestino = Me.cboPuntoVentaDestino.SelectedValue
        cls.Anulado = False
        cls.Observaciones = Me.txt_observaciones.Text
    ...
    Private Function BuscarF1() As String
        ...
        Dim BuscarArt As New FrmBuscarArticulo3
        BuscarArt.IdPuntoVenta1 = cboPuntoVentaOrigen.SelectedValue
        BuscarArt.IdPuntoVenta2 = cboPuntoVentaDestino.SelectedValue
    ...
    Sub agregar_producto()
        ...
        Try
            ...
            viewDatos.Rows.Add(codigo, lb_id.Text, descripcion, cantidad, precio)
    ...
    Private Sub bt_buscar_Click(sender As Object, e As EventArgs) Handles bt_buscar.Click
        Try
            Dim frm As New frmBuscarTrasladoPuntoVenta
        ...
        End Try
    End Sub
    Sub cargar_informacion_prestamo(_IdTrasladoPuntoVenta As String)

        Dim dtEncabezado As New DataTable
        Dim dtDetalle As New DataTable

        Try
            cFunciones.Llenar_Tabla_Generico("select * from TrasladoPuntoVenta where id = " & _IdTrasladoPuntoVenta, dtEncabezado, CadenaConexionSeePOS)
            cFunciones.Llenar_Tabla_Generico("select * from TrasladoPuntoVenta_Detalle where Id_TrasladoPuntoVenta = " & _IdTrasladoPuntoVenta, dtDetalle, CadenaConexionSeePOS)

            If dtEncabezado.Rows.Count > 0 Then

                Me.dt_fecha.Value = dtEncabezado.Rows(0).Item("Fecha")
                Me.cboPuntoVentaOrigen.SelectedValue = dtEncabezado.Rows(0).Item("Id_PuntoVentaOrigen")
                Me.cboPuntoVentaDestino.SelectedValue = dtEncabezado.Rows(0).Item("Id_PuentoVentaDestino")
                Me.txt_observaciones.Text = dtEncabezado.Rows(0).Item("Observaciones")
