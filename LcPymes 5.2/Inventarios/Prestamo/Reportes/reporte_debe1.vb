...
Public Class reporte_debe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.reporte_debe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreporte_debe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_debe = New reporte_debe()
        rpt.Site = Me.Site
        Return rpt
    End Function
