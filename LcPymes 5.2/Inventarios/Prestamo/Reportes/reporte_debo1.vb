...
Public Class reporte_debo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.reporte_debo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreporte_debo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_debo = New reporte_debo()
        rpt.Site = Me.Site
        Return rpt
    End Function
