...
Public Class reporte_debe_empresa
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "reporte_debe_empresa.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.reporte_debe_empresa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreporte_debe_empresa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_debe_empresa = New reporte_debe_empresa()
        rpt.Site = Me.Site
        Return rpt
    End Function
