...
Public Class Reporte_prestamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_prestamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_prestamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_prestamo = New Reporte_prestamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
