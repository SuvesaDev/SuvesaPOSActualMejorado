...
Public Class Reporte_prestamoPVE
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_prestamoPVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_prestamoPVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_prestamoPVE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_prestamoPVE = New Reporte_prestamoPVE()
        rpt.Site = Me.Site
        Return rpt
    End Function
