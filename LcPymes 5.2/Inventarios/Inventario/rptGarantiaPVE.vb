...
Public Class rptGarantiaPVE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptGarantiaPVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGarantiaPVE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGarantiaPVE = New rptGarantiaPVE()
        rpt.Site = Me.Site
        Return rpt
    End Function
