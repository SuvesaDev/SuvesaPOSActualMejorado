...
Public Class rptMovimientoBodega
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMovimientoBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptMovimientoBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMovimientoBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovimientoBodega = New rptMovimientoBodega()
        rpt.Site = Me.Site
        Return rpt
    End Function
