...
Public Class rptAjustesInventario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAjustesInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptAjustesInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAjustesInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAjustesInventario = New rptAjustesInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
