...
Public Class rpAjustesPVE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rpAjustesPVE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpAjustesPVE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpAjustesPVE = New rpAjustesPVE()
        rpt.Site = Me.Site
        Return rpt
    End Function
