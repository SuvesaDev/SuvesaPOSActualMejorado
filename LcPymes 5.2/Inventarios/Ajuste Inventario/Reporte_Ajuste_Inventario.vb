...
Public Class Reporte_Ajuste_Inventario
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Reporte_Ajuste_Inventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_Ajuste_Inventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Ajuste_Inventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Ajuste_Inventario = New Reporte_Ajuste_Inventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
