...
Public Class rptEtiquetasGuanavetClinica
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEtiquetasGuanavetClinica.RPT"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptEtiquetasGuanavetClinica.RPT"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PrimeraEtiqueta() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NumeroCopias() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdAlbaran() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptEtiquetasGuanavetClinica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEtiquetasGuanavetClinica = New rptEtiquetasGuanavetClinica()
        rpt.Site = Me.Site
        Return rpt
    End Function
