...
Public Class EtiquetaSATOCX400_2C
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EtiquetaSATOCX400-2C.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.EtiquetaSATOCX400-2C.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CodigoArticulo() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Cod_Pro() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEtiquetaSATOCX400_2C
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaSATOCX400_2C = New EtiquetaSATOCX400_2C()
        rpt.Site = Me.Site
        Return rpt
    End Function
