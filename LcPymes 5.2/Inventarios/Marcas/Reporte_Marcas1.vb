...
Public Class Reporte_Marcas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_Marcas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Marcas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Marcas = New Reporte_Marcas()
        rpt.Site = Me.Site
        Return rpt
    End Function
