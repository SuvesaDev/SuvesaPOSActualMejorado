...
Public Class rptPedidoBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptPedidoBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPedidoBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPedidoBodega = New rptPedidoBodega()
        rpt.Site = Me.Site
        Return rpt
    End Function
