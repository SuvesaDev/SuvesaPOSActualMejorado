...
Public Class rptEntregaBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptEntregaBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntregaBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntregaBodega = New rptEntregaBodega()
        rpt.Site = Me.Site
        Return rpt
    End Function
