...
Public Class rptTomaGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptTomaGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTomaGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTomaGeneral = New rptTomaGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
