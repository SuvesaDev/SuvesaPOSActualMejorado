...
Public Class rtpTomaProveedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rtpTomaProveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrtpTomaProveedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rtpTomaProveedor = New rtpTomaProveedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
