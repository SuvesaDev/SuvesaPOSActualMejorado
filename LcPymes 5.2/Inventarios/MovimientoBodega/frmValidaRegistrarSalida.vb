...
Public Class frmValidaRegistrarSalida
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblNombre.Location = New System.Drawing.Point(104, 32)
        ...
        Me.Name = "frmValidaRegistrarSalida"
...
#End Region
    ...
    Private Sub Valida(ByVal _pas As String)
        ...
        If dts.Rows.Count > 0 Then
            ...
            If VerificandoAcceso_a_Modulos("AjusteSalida", "AjusteSalida", dts.Rows(0).Item("Cedula"), "Administración") = False Then
                Me.btnAceptar.Enabled = False
