...
Public Class rptTemperaturaCamara
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTemperaturaCamara.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.rptTemperaturaCamara.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTemperaturaCamara
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTemperaturaCamara = New rptTemperaturaCamara()
        rpt.Site = Me.Site
        Return rpt
    End Function
