...
Public Class Reporte_Familias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LcPymes_5._2.Reporte_Familias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Familias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Familias = New Reporte_Familias()
        rpt.Site = Me.Site
        Return rpt
    End Function
